function uibuttongroup_radio()
    ...
    rbg  = uibuttongroup('parent',fh, 'position',[0.02 0.02 0.95 0.4],...
         'Title','unité', 'back',fond,'SelectionChangeFcn',@radio);
    rb1 = uicontrol(rbg,'style', 'radiobutton','position', [0.1 0.1 0.8 0.2],...
        'String', 'steps','back',fond);
    rb2 = uicontrol(rbg,'style', 'radiobutton','position',[0.1 0.4 0.8 0.2],...
        'String', 'degrés','back',fond);
    rb3 = uicontrol(rbg,'style', 'radiobutton','position',[0.1 0.7 0.8 0.2],...
        'String', 'tours','back',fond);
    set(rbg, 'SelectedObject',rb2);
    b1 = uicontrol(fh,'style','pushbutton','Posit',[0.1 0.8 0.8 0.1],'String',...
        'Voir','callback',@voir);
    b1 = uicontrol(fh,'style','pushbutton','Posit',[0.1 0.6 0.8 0.1],...
